          ...
          <div className="flex flex-wrap justify-center gap-2">
            {tenant.links.map((l, i) => (
              <motion.a
                ...
                href={l.url}
                className="rounded-full border border-border bg-card px-4 py-2 text-sm transition duration-200 hover:bg-foreground hover:text-background active:scale-[0.97]"
              >
                {l.label} ↗
              </motion.a>
            ))}
