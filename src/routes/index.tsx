...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://tokolink-v2.vercel.app" },
      { property: "og:image", content: "https://tokolink-v2.vercel.app/og-main.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://tokolink-v2.vercel.app/og-main.png" },
    ...
    links: [{ rel: "canonical", href: "https://tokolink-v2.vercel.app" }],
  }),
  component: Landing,
});
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          operatingSystem: "All",
          url: "https://tokolink-v2.vercel.app",
          offers: {
            "@type": "Offer",
            price: "0",
            priceCurrency: "IDR",
